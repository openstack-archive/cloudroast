...
class RolesTest(BaseIdentityAdminTest):
    ...
    def test_assign_role_to_tenant_user_request_without_token(self):
        (role, tenant, tenant_user) = self._get_role_params()
        assign_role_response = \
            self.missing_token_tenant_client.assign_role_to_tenant_user(
                tenant_id=tenant.id_,
                user_id=tenant_user.id_,
                name=role.name,
                role_id=role.id_)
    ...
    def test_remove_role_to_tenant_user_request_without_token(self):
        ...
        self.missing_token_tenant_client.assign_role_to_tenant_user(
            ...
            role_id=role.id_)
        remove_role_response = \
            self.missing_token_tenant_client.remove_role_of_tenant_user(
                tenant_id=tenant.id_,
                user_id=tenant_user.id_,
                role_id=role.id_)
    ...
    def test_list_tenant_user_roles_request_without_token(self):
        ...
        self.tenant_client.assign_role_to_tenant_user(
            ...
            role_id=role.id_)
        list_roles_response = \
            self.missing_token_tenant_client.get_users_roles_on_tenant(
                tenant_id=tenant.id_,
                user_id=tenant_user.id_)
    ...
    def _set_tenant(self):
        tenant_behavior = TenantsBehaviors(self.tenant_client)
        tenant = tenant_behavior.get_tenant_by_name(name="demo")
        return tenant

    def _set_user(self, tenant):
        response = self.tenant_client.create_user_for_a_tenant(
            tenant_id=tenant.id_, name=rand_name("user-test-"), enabled=True)
        return response.entity

    def _set_role(self):
        response = self.extension_client.create_role(
            name=rand_name("response-test-"))
        return response.entity
