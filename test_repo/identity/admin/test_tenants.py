...
class TenantsTest(BaseIdentityAdminTest):
    ...
    def test_create_tenant_unauthorised_user(self):
        tenant_name = rand_name("tenant-test-")
        tenant_desc = rand_name("desc-test-")
    ...
    def test_list_tenant_unauthorised_user(self):
    ...
    def test_delete_tenant_unauthorised_user(self):
        tenant_name = rand_name("tenant-test-")
        create_response = self.tenant_client.create_tenant(
            name=tenant_name)
        self.addCleanup(self.tenant_client.delete_tenant,
    ...
    def test_update_tenant_unauthorised_user(self):
        tenant_name = rand_name("tenant-test-")
        create_response = self.tenant_client.create_tenant(
            name=tenant_name,
            enabled=True)
