...
class TestProfiles(ProfileFixture):
    ...
    def test_create_profile(self):
        result = self._create_new_profile()
    ...
    def test_delete_profile(self):
        ...
        resp = self._delete_profile(created_id)
    ...
    def test_get_all_profiles(self):
        profile_id_one = self._create_new_profile()['profile_id']
        profile_id_two = self._create_new_profile(name='pro2')['profile_id']
