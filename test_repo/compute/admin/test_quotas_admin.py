...
from cloudcafe.compute.common.defaults import DefaultQuotaSet
...
class QuotasAdminTest(ComputeAdminFixture):
    ...
    def test_get_default_quota_set(self):
        ...
        self.assertEqual(quota.ram, DefaultQuotaSet.RAM,
                         "Ram in quota set is not equal to the default value.")
        self.assertEqual(quota.cores, DefaultQuotaSet.CORES,
