...
class CreateKeypairTest(ComputeFixture):
    ...
    def setUpClass(cls):
        ...
        cls.keypair = cls.create_resp.entity
        cls.resources.add(cls.keypair.name,
    ...
    def test_create_keypair_response(self):
        ...
        self.assertEqual(self.keypair.name, self.name)
        self.assertIsNotNone(self.keypair.public_key)
        self.assertIsNotNone(self.keypair.fingerprint)
    ...
    def test_created_keypair_listed(self):
        ...
        self.assertIn(self.keypair,keypairs_list)
