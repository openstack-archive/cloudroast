...
path_to_report = \
    '/var/lib/jenkins/workspace/Stability/report/report.xml'
path_to_error_report = \
    '/var/lib/jenkins/workspace/Stability/report/error_report.xml'
...
def write_to_error_report(instanceId, exceptionMsg):
    ...
    try:
        ...
        instanceId_element = etree.SubElement(error_header_root, "Instance",
                                              Id=instanceId)
...
def isInstanceActive(dbaasClient, instanceStatus=None, instanceId=None):
    ...
    if instanceId is not None:
        return getInstanceStatus(dbaasClient,
...
def found_resource(dbaas, instanceId=None, databaseName=None, userName=None,
                   limit=1):
    """
