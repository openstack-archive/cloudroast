...
class test_usage_retention(DBaaSFixture):
    ...
    def test_listusage_allwlimit(self):
        ...
        for ro in listOfRetentionObj:
            count += 1
        self.assertEqual(count, lt, "Error: Records listed is not equal to the set limit")
    ...
    def test_listusage_instance(self):
        ...
        self.assertEqual(length_of_records, 1, "Expected records %s, Actual records %s"
                                               % (1, length_of_records))
    ...
    def test_listusage_instance_limit(self):
        ...
        retention = self.mgmt_client.usage.instance(resource_id, limit=50).items
        self.assertIsNotNone(retention, "Expected not None resource")
    ...
    def test_listusage_badlimit(self):
        try:
            ...
            http_code = testutil.get_last_response_code(self.mgmt_client)
