...
class test_databases(DBaaSFixture):
    ...
    def setUpClass(cls):
        ...
        testutil.waitForActive(test_databases.dbaas,
                               instanceId=test_databases.instance_id)
    ...
    def tearDownClass(cls):
        ...
        if test_databases.instance_id is not None:
            status = testutil.getInstanceStatus(
                test_databases.dbaas,
                instanceId=test_databases.instance_id)
            if testutil.isInstanceActive(test_databases.dbaas,
                                         instanceStatus=status):
                test_databases.dbaas.instances.get(
                    test_databases.instance_id).delete()
    ...
    def test_create_db_multiple(self):
        ...
        for _db in _databases:
            ...
            self.assertFalse(testutil.found_resource(
                self.dbaas,
                instanceId=self.instance_id,
