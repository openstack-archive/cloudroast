...
class UsageTest(DBaaSFixture):
    ...
    def test_usage_00_forever(self):
        ...
        print("inst id create: [%r] - %r" % (tc_num,
                                             self.instance_id_list[tc_num]))
    ...
    def test_usage_01_delete_after_create(self):
        ...
        running_time = \
            (datetime.utcnow() - self.starttime_list[tc_num]).seconds
        ...
        AHEventsList = \
            self.dbaas_atomhopper_provider.events_by_resourceId(instance_id)
    ...
    def test_usage_02_resize_flavor_up(self):
        ...
        response = self.client.instances.resize_instance(instance_id,
                                                         NEW_FLAVOR_UP)
        self.assertEqual(str(testutil.get_last_response_code(self.client)),
                         "202",
                         "Error: Resize instance. "
                         "Unexpected resp code: %r != %r"
    ...
    def test_usage_06_resize_reboot_volume_up(self):
        """ Resize the Volume Storage and then reboot,
        ensure only two AH events """
    ...
    def test_usage_07_identical_create(self):
        ...
        time.sleep(self.AHDELAY)
        AHEventsList1 = \
            self.dbaas_atomhopper_provider.events_by_resourceId(instance_id1)
