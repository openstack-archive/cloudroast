...
class perf_parser(object):
    ...
    def parse_log(self):
        ...
        all_stats = ['approx.  95 percentile', 'total number of events', 'avg', 'read', 'write', 'other',
                     'transactions', 'deadlocks', 'total time',
                     'total', 'min', 'other operations', 'Number of threads', 'max', 'events (avg/stddev)',
                     'read/write requests', 'execution time (avg/stddev)']
