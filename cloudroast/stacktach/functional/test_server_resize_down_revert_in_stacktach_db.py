...
from cloudroast.stacktach.fixtures import RevertResizeServerFixture,\
    StackTachTestAssertionsFixture


class StackTachDBServerResizeDownRevertTests(RevertResizeServerFixture,
                                             StackTachTestAssertionsFixture):
    """
    ...
    def setUpClass(cls):
        ...
        (super(StackTachDBServerResizeDownRevertTests, cls)
         .setUpClass(flavor_ref=cls.flavor_ref_alt,
