...
from cloudcafe.stacktach.config import StacktachConfig, MiscConfig
...
class StackTachFixture(BaseTestFixture):
    ...
    def setUpClass(cls):
        ...
        cls.serializer = cls.misc_config.serializer
        cls.deserializer = cls.misc_config.deserializer
