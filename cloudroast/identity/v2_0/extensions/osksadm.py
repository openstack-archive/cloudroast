...
class BaseOSKSADMApiSmoke(object):
    ...
    def test_get_users(self):
        ...
        self.assertTrue(
            r.status_code == self.GET_STATUS_CODE,
    ...
    def test_create_user(self):
        ...
        self.assertTrue(
            r.status_code == self.CREATE_STATUS_CODE,
            "Status Code Fail:{0}".format(r.status_code))
    ...
    def test_update_user(self):
        ...
        if r.ok:
            self.assertIsNotNone(r.entity, "Invalid body in response")
        self.assertTrue(
            r.status_code == self.UPDATE_STATUS_CODE,
            "Status Code Fail:{0}".format(r.status_code))
    ...
    def test_delete_user(self):
        ...
        self.assertTrue(
            r.status_code == self.DELETE_STATUS_CODE,
            "Status Code Fail:{0}".format(r.status_code))
    ...
    def test_add_global_role_to_user(self):
        ...
        if r.ok:
            self.assertIsNotNone(r.entity, "Invalid body in response")
        self.assertTrue(
            r.status_code == self.ADD_STATUS_CODE,
            "Status Code Fail:{0}".format(r.status_code))
