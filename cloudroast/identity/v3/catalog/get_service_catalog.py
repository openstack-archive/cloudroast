...
class TestCatalog(IdentityV3Fixture):
    ...
    def test_get_service_catalog(self):
        ...
        self._verify_assertion(resp=resp)

    def _verify_assertion(self, resp):
        """
        Verify the response received for the catalog
        """
        ...
        # Catalog verifications - Verify the response received for catalog
        # for ex:type is not none as the catalog information may change
    ...
    def test_list_users(self):
        """ List users is not listed as one of the call for MVP. This call is
