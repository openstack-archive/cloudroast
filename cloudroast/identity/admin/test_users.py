...
class UsersTest(BaseIdentityAdminTest):
    ...
    def test_create_user_for_tenant(self):
        ...
        self.assertEqual(self.user_name, user.name)
        self.assertEqual(self.user_email, user.email)
        self.assertEqual(self.user_enabled, user.enabled)
        self.assertEqual(self.demo_tenant.id_, user.tenant_id)
