...
class GetImagesSchemaTest(ImagesV2Fixture):
    ...
    def test_get_image_schema(self):
        ...
        """
        1) Get image schema
        2) Verify the schema displays correctly with all elements
        """

        response = self.api_client.get_image_schema()
        image_schema = response.entity
        self.assertEqual(200, response.status_code)
        """@TODO: Add check to verify all expected elements are
        returned in the image schema response"""
    ...
    def test_get_images_schema(self):
        ...
        self.assertEqual(200, response.status_code)
        """@TODO: Add check to verify all expected elements are
        returned in the images schema response"""
