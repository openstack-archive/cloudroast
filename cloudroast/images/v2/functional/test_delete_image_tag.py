...
class TestDeleteImageTag(ImagesFixture):
    ...
    def test_delete_image_tags(self):
        ...
        4) Verify that the response code is 200
        5) Verify that the image tag is in the list of image tags
        6) Repeat steps 1-5 for number_of_tags
        7) Delete image tag
        8) Verify that the response code is 204
        9) Get image
        10) Verify that the response code is 200
        11) Verify that the image tag is not in the list of image tags
        12) Repeat stesp 7-11 for number_of_tags
        13) Get image
        14) Verify that the response code is 200
        15) Verify that the list of image tags is empty
        """
