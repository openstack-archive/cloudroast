...
class TestRemoveSharedImageFromUserBImageList(ImagesFixture):

    @tags(type='positive', regression='true')
    def test_remove_shared_image_from_user_b_image_list(self):
        """
        @summary: Remove shared image from user b's image list
