...
class TestImageDiscoveryOfImagesAvailableToUserB(ImagesFixture):

    @tags(type='positive', regression='true')
    def test_image_discovery_of_images_available_to_user_b(self):
        """
        @summary: Image discovery of images available to user b
