...
class PostImagesTest(ImagesV2Fixture):
    ...
    def test_register_image_with_compulsory_properties(self):
        ...
        response = self.api_client.create_image(name=image_name,
                                                container_format='bare',
                                                disk_format='raw')

        self.assertEqual(response.status_code, 201,
                         self.msg.format('status_code', 201,
        ...
        self.assertEqual(image.disk_format, 'raw',
                         self.msg.format('disk_format', 'raw',
                                         image.disk_format))
    ...
    def test_register_image_that_is_already_registered(self):
        ...
        self.assertNotEqual(first_image.id_, second_image.id_,
                            self.msg.format('id', first_image.id_,
                                            second_image.id_))
    ...
    def test_register_image_with_unacceptable_disk_format(self):
        ...
        self.assertEqual(response.status_code, 400,
                         self.msg.format('status_code', 400,
                                         response.status_code))
