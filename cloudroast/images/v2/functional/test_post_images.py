...
class PostImagesTest(ImagesV2Fixture):
    ...
    def test_register_image_with_compulsory_properties(self):
        ...
        self.assertEqual(image.name, image_name,
                         MSG.format('image_name', image_name, image.name))
        self.assertEqual(image.disk_format, 'raw',
                         MSG.format('disk_format', 'raw', image.disk_format))
        self.assertEqual(image.container_format, 'bare',
                         MSG.format('container_format', 'bare',
    ...
    def test_register_image_with_optional_properties(self):
        ...
        self.assertEqual(image.visibility, 'public',
                         MSG.format('visibility', 'public', image.visibility))
    ...
    def test_register_image_with_unacceptable_disk_format(self):
        ...
        self.assertEqual(response.status_code, 400,
                         MSG.format('status_code', 400, response.status_code))
