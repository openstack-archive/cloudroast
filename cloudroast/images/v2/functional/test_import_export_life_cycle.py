...
class TestImportExportLifeCycle(ComputeIntegrationFixture):

    @unittest.skip('Bug, Redmine #4729')
    ...
    def test_import_export_life_cycle(self):
        ...
        8) Create a snapshot of the snapshot
        ...
        image = self.compute_image_behaviors.create_active_image(server.id)
