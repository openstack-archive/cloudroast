...
class ImageDiscoverySharedImagesOwnedByUserTest(ComputeIntegrationFixture):
    ...
    def test_image_discovery_of_shared_images_owned_by_user(self):
        ...
        images_list = self.images_behavior.create_images_via_task(count=3)
        ...
        for image_id in [x.id_ for x in images_list]:
        ...
        image_one = images_list.pop()
        image_two = images_list.pop()
        image_three = images_list.pop()
