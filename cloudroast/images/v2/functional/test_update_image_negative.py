...
class TestUpdateImageNegative(ImagesFixture):
    ...
    def test_update_image_property_quota_limit(self):
        ...
        limit = quota_limit - len(image.additional_properties)
        # Also account for 'image_type' as being an extra property
        ...
        get_image = response.entity
        # Also account for 'image_type' as being an extra property
        self.assertEqual(len(get_image.additional_properties) + 1, quota_limit)
