...
class ImagesFixture(BaseTestFixture):
    ...
    def setUpClass(cls):
        ...
        cls.test_file = cls.read_data_file_path(cls.images_config.test_file)
        cls.image_schema_json = cls.read_data_file_path(
            cls.images_config.image_schema_json)
        cls.images_schema_json = cls.read_data_file_path(
            cls.images_config.images_schema_json)
        cls.image_member_schema_json = cls.read_data_file_path(
            cls.images_config.image_member_schema_json)
        cls.image_members_schema_json = cls.read_data_file_path(
            cls.images_config.image_members_schema_json)
        cls.task_schema_json = cls.read_data_file_path(
            cls.images_config.task_schema_json)
        cls.tasks_schema_json = cls.read_data_file_path(
    ...
    @classmethod
    def read_data_file_path(cls, file_path):
