...
class NetworkingAPIFixture(NetworkingFixture):
    ...
    def get_ipv4_host_route_data(self, n=1):
        """IPv4 host routes test data (n host routes, quota is 3)"""
        ...
        if n:
            ipv4_ips = self.subnets.behaviors.get_ips(
                cidr=host_route_cidrv4, increment=7, n=n)
    ...
    def get_ipv6_host_route_data(self, n=1):
        ...
        if n:
            ipv6_ips = self.subnets.behaviors.get_ips(
                cidr=host_route_cidrv6, increment=100, n=n)
