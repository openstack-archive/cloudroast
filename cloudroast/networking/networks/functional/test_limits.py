...
class TestLimits(NetworkingComputeFixture, ScenarioMixin):
    ...
    def test_public_ping(self):
        ...
        for ip_addr in pub_ipv4_addr:
            ip_addr_reachable = PingClient.ping(ip=ip_addr, ip_address_version=4, num_pings=100)
    ...
    def _test_remote_ping(self, port_type):
        ...
        icmp_basic = dict(port_type=port_type, protocol='icmp', ip_version=4, count=100)
