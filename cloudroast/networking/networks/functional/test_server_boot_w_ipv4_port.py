...
class ServersBootTestWithPortIPv4(NetworkingComputeFixture):

    @tags('servers', 'positive', 'rbac_creator')
    def test_server_boot_w_ipv4_port_id(self):
        """
        @summary: Booting a server with port_id from an IPv4 port
        """
        network = self.create_network()
        subnet = self.create_subnet(network_id=network.id)
        ...
        server_persona = ServerPersona(
            ...
            subnetv4=subnet, portv4=port, subnetv6=None, portv6=None,
