...
class SecurityGroupsTest(NetworkingComputeFixture,
    ...
    def setUpClass(cls):
        ...
        cls.secgroups_client = cls.security_groups.client
    ...
    def _get_listener_port_id(cls):
        ...
        @rtype: string
        """
        resp = cls.ports_client.list_ports(device_id=cls.listener.entity.id,
        ...
        msg = ("Ports list returned unexpected number of ports given provided "
               "filter. Expected 1 port, {} returned")
    ...
    def _create_empty_security_group(cls, name):
        ...
        resp = cls.secgroups_client.create_security_group(name=sg_name,
                                                          description=sg_desc)
    ...
    def _create_security_group_rule(cls, secgroup_id, direction, ethertype,
        ...
        """
        resp = cls.secgroups_client.create_security_group_rule(secgroup_id,
                                                               direction,
                                                               ethertype,
                                                               **kwargs)
    ...
    def _create_open_loginable_secgroup(cls, secgroup=None):
        ...
        """
        if secgroup:
            resp = cls.secgroups_client.get_security_group(secgroup.id)
            ...
            for rule in sg.security_group_rules:
                resp = cls.secgroups_client.delete_security_group_rule(rule.id)
    ...
    def _update_port_secgroups(self, security_groups_ids):
        resp = self.ports_client.update_port(
    ...
    def _verify_udp_communication(self, sender_client, port, is_open):
        netcat_sender = '{} -z -v -u -w5 {} {}'.format(self.NETCAT,
