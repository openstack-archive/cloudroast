...
class SecurityGroupsEgressIPv4Test(NetworkingComputeFixture):
    ...
    def setUpClass(cls):
        ...
        server_names = {'listener': 'sg_egress_listenerv4',
                        'sender': 'sg_egress_senderv4',
                        'icmp_sender': 'sg_egress_icmp_senderv4',
                        'other_sender': 'sg_egress_otherv4'}

        cls.create_multiple_servers(base_name='sg_egress_v4', ip_version=4,
