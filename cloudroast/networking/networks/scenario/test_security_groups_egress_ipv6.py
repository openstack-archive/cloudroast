...
class SecurityGroupsEgressIPv6Test(NetworkingComputeFixture):
    ...
    def setUpClass(cls):
        ...
        cls.listener = cls.create_test_server(
            name='sg_egress_listenerv6', key_name=cls.keypair.name,
