...
class SecurityGroupsEgressIPv6Test(NetworkingComputeFixture):
    ...
    def setUpClass(cls):
        ...
        # Creating servers as class attributes, for ex. cls.listener, etc.
        server_names = {'listener': 'sg_egress_listenerv6',
                        'sender': 'sg_egress_senderv6',
                        'icmp_sender': 'sg_egress_icmp_senderv6',
                        'other_sender': 'sg_egress_otherv6'}

        cls.create_multiple_servers(base_name='sg_egress_v6', ip_version=6,
