...
data_set_list.append_new_dataset(
    ...
    data_dict={'protocol': 'icmp', 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
    name='w_protocol_tcp',
    data_dict={'protocol': 'tcp', 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
    name='w_protocol_udp',
    data_dict={'protocol': 'udp', 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
    name='w_ethertype_ipv4',
    data_dict={'ethertype': 'IPv4', 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
    name='w_ethertype_ipv6',
    data_dict={'ethertype': 'IPv6', 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
    name='w_protocol_icmp_and_port_ranges',
    data_dict={'protocol': 'icmp', 'port_range_min': 0,
               'port_range_max': 255, 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
    name='w_protocol_icmp',
    data_dict={'protocol': 'icmp', 'direction': 'egress'},
...
data_set_list.append_new_dataset(
    ...
    data_dict={'protocol': 'icmp', 'port_range_min': 2, 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
...
data_set_list.append_new_dataset(
    ...
    data_dict={'remote_ip_prefix': '192.168.86.0/24', 'direction': 'egress'},
    tags=['sec_group_egress', 'post', 'positive', 'rbac_creator'])
data_set_list.append_new_dataset(
...
data_set_list_negative.append_new_dataset(
    ...
    data_dict={'direction': 'egress',
               'port_range_min': 1, 'port_range_max': 255,
               'http_status': 'BAD_REQUEST',
...
data_set_list_negative.append_new_dataset(
    ...
    data_dict={'direction': 'egress',
               'protocol': 'icmp', "port_range_min": 1,
...
data_set_list_negative.append_new_dataset(
    ...
    data_dict={'direction': 'egress',
               ...
               'http_status': 'BAD_REQUEST',
               'test_desc': ('Etherytype IPv4 does not match '
...
data_set_list_negative.append_new_dataset(
    ...
    data_dict={'direction': 'egress',
               ...
               'http_status': 'BAD_REQUEST',
               'test_desc': ('Etherytype IPv6 does not match '
...
data_set_list_negative.append_new_dataset(
    ...
    data_dict={'direction': 'egress',
               ...
               'http_status': 'BAD_REQUEST',
               'test_desc': ('ICMP requires port_range_min when '
                             'port_range_max given'),
...
class SecurityGroupRuleCreateTest(NetworkingSecurityGroupsFixture):
    ...
    def setUpClass(cls):
        ...
        cls.expected_secgroup.name = 'test_secgroup_rule_create_egress'
