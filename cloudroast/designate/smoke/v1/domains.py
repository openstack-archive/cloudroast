...
class DomainTest(DomainsFixture):
    ...
    def test_list_domains(self):
        self.domain_behaviors.create_domain()
    ...
    def test_create_domain(self):
        create_resp = self.domain_behaviors.create_domain()
    ...
    def test_update_domain(self):
        ...
        create_resp = self.domain_behaviors.create_domain(name=name,
                                                          email=email,
                                                          ttl=3600)
        domain_id = create_resp.entity.id

        new_email = "new_" + email
        update_resp = self.domain_client.update_domain(domain_id=domain_id,
                                                       email=new_email,
                                                       name=name,
                                                       ttl=1800)
    ...
    def test_delete_domain(self):
        ...
        del_resp = self.domain_behaviors.delete_domain(domain_id)
