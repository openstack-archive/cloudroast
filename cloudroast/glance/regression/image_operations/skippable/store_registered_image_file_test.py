...
class StoreRegisteredImageFile(ImagesFixture):
    ...
    def test_store_image_file_using_deactivated_image(self):
        """
    ...
    def test_store_image_file_using_reactivated_image(self):
        """
        @summary: Store image file using reactivated image

        1) Store image file using reactivated image
        2) Verify that the response code is 204
        3) Get image file of the image
        4) Verify that the response is ok
        5) Verify that the image file contains the correct data
        """
