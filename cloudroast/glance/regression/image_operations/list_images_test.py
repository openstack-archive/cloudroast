...
class ListImages(ImagesIntegrationFixture):
    ...
    def test_sort_images_list_using_multiple_sort_keys_only(self):
        ...
        4) If the two images being compared have the same value for the first
        ...
        sort_pairs = ['sort_key={0}'.format(key) for key in sort_keys]
    ...
    def test_sort_images_list_using_multiple_sort_keys_and_sort_dirs(self):
        ...
        sort_keys_dirs = {
            'name': SortDirection.ASCENDING, 'size': SortDirection.DESCENDING}

        sort_pairs = ['sort_key={0}&sort_dir={1}'.format(key, value)
