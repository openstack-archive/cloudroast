...
class GetImageMembersSchema(ImagesFixture):

    def test_get_image_members_schema(self):
        """
        @summary: Get image members json schema

        1) Retrieve the image members schema json resp file
        2) Get image members json schema
        3) Verify the response status code is 200
        4) Verify that the response body contain the expected image members
        ...
        self.assertEqual(resp.content, image_members_schema_resp)
