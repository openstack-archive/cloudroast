...
class ImageSharing(ImagesIntergrationFixture):
    ...
    def setUpClass(cls):
        ...
        cls.resources.add(
            cls.imported_image.id_, cls.images.client.delete_image)
        cls.images.client.create_image_member(
        ...
        cls.snapshot_image = cls.images.behaviors.create_image_via_task(
            import_from=cls.images.config.import_from_bootable)
        cls.resources.add(
            cls.snapshot_image.id_, cls.images.client.delete_image)
        cls.images.client.create_image_member(
        ...
        cls.alt_snapshot_image = cls.images.behaviors.create_image_via_task(
            import_from=cls.images.config.import_from_bootable)
        cls.resources.add(
            cls.alt_snapshot_image.id_, cls.images.client.delete_image)
        cls.images.client.create_image_member(
    ...
    def test_delete_shared_image_accessibility(self):
        ...
        4) Verify that the response is a 404
        ...
        7) Verify that the response is a 404
