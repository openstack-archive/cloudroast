...
class GetImageMember(ImagesFixture):
    ...
    def test_get_image_member_using_not_shared_image(self):
        """
        @summary: Get image member using an image that is not shared

        1) Get image member using an image that is not shared
        2) Verify that the response code is 404
        """
