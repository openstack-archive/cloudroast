...
def load_tests(loader, standard_tests, pattern):
    suite = TestSuite()
    suite.addTest(VolumesIntegrationTest(
        "test_can_create_volume_from_deactivated_image"))
    suite.addTest(VolumesIntegrationTest(
        "test_can_create_volume_from_reactivated_image"))
    return suite


class VolumesIntegrationTest(ImagesIntegrationFixture):
    ...
    def setUpClass(cls):
        ...
        """
        super(VolumesIntegrationTest, cls).setUpClass()
    ...
    def test_can_create_volume_from_deactivated_image(self):
    ...
    def test_can_create_volume_from_reactivated_image(self):
