...
def load_tests(loader, standard_tests, pattern):
    suite = TestSuite()
    suite.addTest(VolumeServerIntegrationTest(
...
class VolumeServerIntegrationTest(ImagesIntegrationFixture):
    ...
    def setUpClass(cls):
        ...
        """
        super(VolumeServerIntegrationTest, cls).setUpClass()
    ...
    def test_can_create_volume_server_from_deactivated_image(self):
        """
    ...
    def test_can_create_volume_server_from_reactivated_image(self):
        """
