...
def load_tests(loader, standard_tests, pattern):
    suite = TestSuite()
    suite.addTest(ServerIntegrationTest(
...
class ServerIntegrationTest(ImagesIntegrationFixture):
    ...
    def setUpClass(cls):
        ...
        """
        super(ServerIntegrationTest, cls).setUpClass()
    ...
    def test_can_create_server_from_deactivated_image(self):
        """
    ...
    def test_can_create_server_from_reactivated_image(self):
        """
