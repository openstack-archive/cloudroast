...
class ImagesDatasetListGenerator(object):
    ...
    def ListImagesFilters():
        ...
        additional_prop_value = images.config.additional_property_value
        ...
        size_max = random_int(0, 9999999)
        size_min = random_int(0, 999999)
        ...
        dataset_list.append_new_dataset(
            'passing_additional_property',
            {'params': {additional_prop: additional_prop_value}})
        dataset_list.append_new_dataset(
        ...
        dataset_list.append_new_dataset(
            'passing_size_max', {'params': {'size_max': size_max}})
        dataset_list.append_new_dataset(
            'passing_size_max_and_size_min',
            {'params': {'size_max': size_max, 'size_min': size_min}})
        dataset_list.append_new_dataset(
            'passing_size_min', {'params': {'size_min': size_min}})
        dataset_list.append_new_dataset(
            'passing_status', {'params': {'status': status}})
        dataset_list.append_new_dataset(
            'passing_tag', {'params': {'tag': tag}})
        dataset_list.append_new_dataset(
    ...
    def ListImagesSort():
        ...
        properties = [
            ...
            'container_format', 'created_at', 'disk_format', 'id',
            'image_type', 'min_disk', 'min_ram', 'name', 'os_type', 'owner',
            'protected', 'size', 'status', 'tags', 'updated_at', 'user_id',
            'visibility']
