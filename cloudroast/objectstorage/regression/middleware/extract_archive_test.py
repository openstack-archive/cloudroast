...
class ExtractArchiveTest(ObjectStorageFixture):
    ...
    def test_extract_tar_archive_to_existing_container(self):
        ...
        self.assertEqual(
            ...
            " recieved: {1} extracted objects".format(expected, recieved))
        ...
        for name in resp_obj_names:
            ...
            recieved = response.content
            self.assertEqual(
                expected,
                recieved,
                msg="obj content expected: {0} recieved: {1}".format(
                    expected,
                    recieved))
    ...
    def test_object_creation_with_tar_archive(self):
        ...
        self.assertEqual(
            ...
            " code: {0} recieved: {1}".format(expected, recieved))
