...
class ObjectStorageFixture(BaseTestFixture):
    ...
    def setUpClass(cls):
        ...
        cls.auth_data = auth_composite.auth_info
        cls.objectstorage_api_config = auth_composite.config
        cls.storage_url = auth_composite.storage_url
        cls.auth_token = auth_composite.auth_token
        cls.base_container_name = (
            cls.objectstorage_api_config.base_container_name)
        cls.client = auth_composite.client
        cls.behaviors = auth_composite.behaviors
