...
class ServerAdminRescueTests(object):
    ...
    def test_rescue_and_unrescue_server_as_admin_test(self):
        ...
        This test will be successful if:
            - The Rescue call is successful
            - Rescue does in fact change the password
            - Server reach RESCUE status
            - The Un-rescue call is successful
            - Server reach ACTIVE status
        """
