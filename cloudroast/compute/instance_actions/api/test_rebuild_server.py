...
class RebuildServerTests(object):
    ...
    def test_server_ram_after_rebuild(self):
        ...
        up. Calculate the minimum acceptable RAM value, this value is 90% of the
        RAM value of the flavor from test configuration. Validate that the RAM
        of the server is equal to the RAM value of the flavor from the test
