...
class XMLTest(ComputeFixture):
    ...
    def tearDownClass(cls):
        ...
        super(XMLTest, cls).tearDownClass()
    ...
    def test_get_request_accept_xml(self):
        """
        A GET request passing only the accept header as xml
    ...
    @tags(type='smoke', net='no')
    def test_get_request_content_type_xml(self):
        """
        A GET request passing only the content-type header as xml
    ...
    @tags(type='smoke', net='no')
    def test_get_request_accept_and_content_type_xml(self):
        """
        A GET request passing both the accept and content-type headers as xml
    ...
    @tags(type='smoke', net='no')
    def test_post_request_accept_xml(self):
        """
        A POST request passing only the accept header as xml
    ...
    @tags(type='smoke', net='no')
    def test_post_request_content_type_xml(self):
        """
        A POST request passing only the content-type header as xml
    ...
    @tags(type='smoke', net='no')
    def test_post_request_accept_and_content_type_xml(self):
        """
        A POST request passing both the accept and content-type headers as xml
