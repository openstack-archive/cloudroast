...
class RebootServerSoftTests(ComputeFixture):
    ...
    def setUpClass(cls):
        ...
        The following actions are performed during this set up:
            ...
            - A fresh remote instant client is set up for the rebooted server
            - A fresh remote instant client is set up again for the rebooted
              server
            - The config drive is mounted at the base path set during test
    ...
    def test_directory_present_after_soft_reboot(self):
        ...
        content is present after the server soft rebooted during test set up is
        True.
    ...
    def test_soft_reboot_openstack_metadata(self):
        ...
        during test setup. Validate that the metadata after reboot matches the
