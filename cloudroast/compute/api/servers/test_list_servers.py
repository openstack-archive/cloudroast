...
class ServerListTest(ComputeFixture):
    ...
    def setUpClass(cls):
        ...
        The following resources are created/defined during the setup
            ...
            - Image creation from servers (waits for active)
            - 3rd server from image created in step above
        """
    ...
    def test_list_servers_with_detail(self):
        ...
        After the list_servers_with_details is called, it grabs the entity, then iterates through the details
