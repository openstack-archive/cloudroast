...
class FlavorsTest(ComputeFixture):
    ...
    def setUpClass(cls):
        ...
        The following resources are created during this setup:
            - a list of flavors
        The follow data is generated during this setup:
    ...
    def test_list_flavors(self):
        ...
        This test will be successful if:
            - The test user is able to get a list of available flavors
            - The list of flavors is not empty
            - The test user is able to get details for the flavor set during
              test configuration
    ...
    def test_list_flavors_with_detail(self):
        ...
        This test will be successful if:
            - The test user is able to get a detailed list of available flavors
            - The list of flavors is not empty
            - The test user is able to get details for the flavor set during
              test configuration
            - The flavor set during test configuration is found in the list
    ...
    def test_get_flavor(self):
        ...
        This test will be successful if:
            - The test user is able to get details for the flavor set during
              test configuration
            - The flavor ref returned in the flavor details matches the
              flavor ref set during test configuration.
        """
        response = self.flavors_client.get_flavor_details(self.flavor_ref)
        flavor = response.entity
    ...
    def test_get_non_existent_flavor(self):
        """
        A test user should not be able to get details for a flavor

        Get detailed flavor information about the flavor set during test
        configuration. Ensure that the flavor is not found.
        This test will be successful if:
            - A request to get a non existent flavor returns a 'Item Not
              Found' error
        """
        try:
    ...
    def test_list_flavors_limit_results(self):
        ...
        This test will be successful if:
            - The test user can request a list of flavors with a page size
              of 1
            - The list contains only one flavor
        """
    ...
    def test_list_flavors_detailed_limit_results(self):
        ...
        the flavor list returned contains only one flavor.
        This test will be successful if:
            - The test user can request a detailed list of flavors with
              a page size of 1
            - The list contains only one flavor
        """
    ...
    def test_list_flavors_using_marker(self):
        ...
        This test will be successful if:
            - The test user can request a list of flavors
            - The list of flavors is populated
            - The test user can request a list of flavors using the
              first flavor in the list as a marker
            - The returned list does not contain the selected flavor
        """
        response = self.flavors_client.list_flavors()
        flavors = response.entity
    ...
    def test_list_flavors_detailed_using_marker(self):
        ...
        list should not contain the selected flavor.
        This test will be successful if:
            - The test user can request a detailed list of flavors
            - The list of flavors is populated
            - The test user can request a detailed list of flavors using the
              first flavor in the list as a marker
            - The returned list does not contain the selected flavor
        """
        response = self.flavors_client.list_flavors_with_detail()
    ...
    def test_list_flavors_detailed_filter_by_min_disk(self):
        ...
        list of flavors. The returned list should contain only images
        with equal or greater disk size than the selected flavor.
        This test will be successful if:
            - The test user can request a detailed list of flavors
            - The test user can request a detailed list of flavors using the
              flavor containing the second smallest disk size as the
              minimum disk parameter
            - The returned list only contains flavors with equal or greater
              disk size than the selected flavor
        """
        response = self.flavors_client.list_flavors_with_detail()
        flavors = response.entity
    ...
    def test_list_flavors_detailed_filter_by_min_ram(self):
        ...
        flavors. The returned list should contain only images with equal
        or greater RAM value than the selected flavor.
        This test will be successful if:
            - The test user can request a detailed list of flavors
            - The test user can request a detailed list of flavors using the
              flavor containing the second smallest RAM value as the
              minimum RAM parameter
            - The returned list only contains flavors with equal or greater
              RAM value than the selected flavor
        """
        response = self.flavors_client.list_flavors_with_detail()
        flavors = response.entity
    ...
    def test_list_flavors_filter_by_min_disk(self):
        ...
        The returned list should contain only images with equal or
    ...
    def test_list_flavors_detailed_min_disk_larger_than_max_flavor_disk(self):
        ...
        This test will be successful if:
            - The test user can request a detailed list of flavors using
              a disk size larger than the disk size of any available flavors
              as the minimum disk parameter
    ...
    def test_list_flavors_detailed_min_ram_larger_than_max_flavor_ram(self):
        ...
        This test will be successful if:
            - The test user can request a detailed list of flavors using
              a RAM value larger than the RAM value of any available flavors
              as the minimum RAM parameter
            - The returned list should be empty
        """
        response = self.flavors_client.list_flavors_with_detail(
    ...
    def test_list_flavors_min_disk_greater_than_max_flavor_disk(self):
        ...
        of flavors. The returned list should contain no flavors.
        This test will be successful if:
            - The test user can request a list of flavors using a disk
              size larger than the disk size of any available flavors
              as the minimum disk parameter
            - The returned list should be empty
        """
