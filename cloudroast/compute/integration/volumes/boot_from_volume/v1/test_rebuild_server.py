...
class ServerFromVolumeV1RebuildTests(ServerFromVolumeV1Fixture,
    ...
    def setUpClass(cls):
        ...
        The following resources are created during this setup:
            ...
            - Rebuilds and waits for server to ba active again.
        """
    ...
    def test_rebuilt_volume_server_disk_size(self):
        ...
        from the server to validate the volume size is correct.

        The following assertions occur:
            - The volume size is equal to defined size at rebuild.
        """
