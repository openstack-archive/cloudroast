...
class CreateVolumeServerNegativeTest(ServerFromVolumeV2Fixture):
    ...
    def test_delete_on_terminate_invalid(self):
        """
        Verify delete on termination set to invalid on block device fails.
        ...
        exception to be raised because the block device had delete on
        termination set to "invalid".
    ...
    def test_flavor_invalid(self):
        ...
        "BadRequest" exception to be raised becasue the server has a flavor
        ref set to "invalid".
