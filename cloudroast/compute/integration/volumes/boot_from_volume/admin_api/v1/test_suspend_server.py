...
class ServerFromVolumeV1SuspendTests(ServerFromVolumeV1Fixture,
                                     SuspendServerTests):
    ...
    def setUpClass(cls):
        ...
        """
        super(ServerFromVolumeV1SuspendTests, cls).setUpClass()
...
class ServerFromVolumeV1NegativeSuspendTests(ServerFromVolumeV1Fixture,
    ...
    def setUpClass(cls):
        ...
        The following resources are created during this setup:
            - Create an active server.
        """
        super(ServerFromVolumeV1NegativeSuspendTests, cls).setUpClass()
        cls.compute_admin = ComputeAdminComposite()
        cls.admin_servers_client = cls.compute_admin.servers.client
        cls.admin_server_behaviors = cls.compute_admin.servers.behaviors
        cls.create_server()
