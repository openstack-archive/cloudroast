...
class RebuildServerVolumeIntegrationTest(BlockstorageIntegrationFixture):
    ...
    def setUpClass(cls):
        ...
        cls.blockstorage_behavior.wait_for_volume_status(
            cls.volume.id_, statuses.Volume.IN_USE, cls.volume_create_timeout)
    ...
    def test_rebuild_server(self):
        ...
        "R3builds3ver".  Will call the rebuild server with new name, password
        and the key that was generated during setup.  Then will wait for
    ...
    def test_volume_detached_after_rebuild(self):
        """
        Verify that the volume is available after being rebuilt.
    ...
    def test_reattach_volume_after_rebuild(self):
        ...
        self.blockstorage_behavior.wait_for_volume_status(
            self.volume.id_, 'in-use', self.volume_create_timeout)
