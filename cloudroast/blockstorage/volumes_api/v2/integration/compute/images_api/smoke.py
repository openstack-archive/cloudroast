...
class VolumesImagesIntegrationSmoke(VolumesImagesIntegrationFixture):
    ...
    @data_driven_test(IntegrationDatasets.images_by_volume_type(
    ...
    @data_driven_test(IntegrationDatasets.configured_images_by_volume_type())
