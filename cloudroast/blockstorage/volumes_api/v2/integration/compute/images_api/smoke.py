...
from cloudroast.blockstorage.volumes_api.v2.integration.compute.datasets \
    import Generators as integration_datasets
...
class VolumesImagesIntegrationSmoke(VolumesImagesIntegrationFixture):
    ...
    @data_driven_test(integration_datasets.images_by_volume_type(
    ...
    @data_driven_test(integration_datasets.configured_images_by_volume_type())
