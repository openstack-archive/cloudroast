...
class ComputeIntegrationTestFixture(VolumesTestFixture):
    ...
    def format_attached_volume(
        ...
        if device_name.startswith('/dev'):
            r = server_connection.format_disk(device_name, fstype or 'ext3')
        else:
            r = server_connection.format_disk(device_name, fstype or 'ntfs')
    ...
    def mount_attached_volume(
        ...
        r = server_connection.mount_disk(
    ...
    def connect_to_instance(
        ...
        os_type = cls.get_server_instance_os_type(server_instance_model)
